...
const uint32_t TableStruct_StudentsGroup_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::protobuf::StudentsGroup, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::protobuf::StudentsGroup, students_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::protobuf::StudentsGroup)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::protobuf::_StudentsGroup_default_instance_),
};

const char descriptor_table_protodef_StudentsGroup_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\023StudentsGroup.proto\022\010protobuf\032\rStudent"
  ".proto\"4\n\rStudentsGroup\022#\n\010students\030\001 \003("
  "\0132\021.protobuf.Studentb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_StudentsGroup_2eproto = {
  false, false, 108, descriptor_table_protodef_StudentsGroup_2eproto, "StudentsGroup.proto", 
...
StudentsGroup::StudentsGroup(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:protobuf.StudentsGroup)
}
StudentsGroup::StudentsGroup(const StudentsGroup& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      students_(from.students_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:protobuf.StudentsGroup)
}
...
StudentsGroup::~StudentsGroup() {
  // @@protoc_insertion_point(destructor:protobuf.StudentsGroup)
...
// @@protoc_insertion_point(message_clear_start:protobuf.StudentsGroup)
...
uint8_t* StudentsGroup::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:protobuf.StudentsGroup)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:protobuf.StudentsGroup)
  return target;
}

size_t StudentsGroup::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:protobuf.StudentsGroup)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:protobuf.StudentsGroup)
...
// @@protoc_insertion_point(class_specific_copy_from_start:protobuf.StudentsGroup)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::protobuf::StudentsGroup* Arena::CreateMaybeMessage< ::protobuf::StudentsGroup >(Arena* arena) {
  return Arena::CreateMessageInternal< ::protobuf::StudentsGroup >(arena);
}

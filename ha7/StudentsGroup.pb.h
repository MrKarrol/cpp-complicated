...
PROTOBUF_NAMESPACE_OPEN
template<> ::protobuf::StudentsGroup* Arena::CreateMaybeMessage<::protobuf::StudentsGroup>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace protobuf {
...
class StudentsGroup final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:protobuf.StudentsGroup) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:protobuf.StudentsGroup)
 private:
  class _Internal;
...
inline ::protobuf::Student* StudentsGroup::mutable_students(int index) {
  // @@protoc_insertion_point(field_mutable:protobuf.StudentsGroup.students)
...
StudentsGroup::mutable_students() {
  // @@protoc_insertion_point(field_mutable_list:protobuf.StudentsGroup.students)
  return &students_;
}
inline const ::protobuf::Student& StudentsGroup::_internal_students(int index) const {
  return students_.Get(index);
}
inline const ::protobuf::Student& StudentsGroup::students(int index) const {
  // @@protoc_insertion_point(field_get:protobuf.StudentsGroup.students)
  return _internal_students(index);
}
inline ::protobuf::Student* StudentsGroup::_internal_add_students() {
  return students_.Add();
}
inline ::protobuf::Student* StudentsGroup::add_students() {
  ::protobuf::Student* _add = _internal_add_students();
  // @@protoc_insertion_point(field_add:protobuf.StudentsGroup.students)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::protobuf::Student >&
StudentsGroup::students() const {
  // @@protoc_insertion_point(field_list:protobuf.StudentsGroup.students)
  return students_;
}
